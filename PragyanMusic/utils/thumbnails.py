...
async def get_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("PragyanMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("PragyanMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("PragyanMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("PragyanMusic/assets/play_icons.png")
